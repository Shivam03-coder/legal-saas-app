...
const Main = () => {
  return (
    <main className="min-h-screen px-8 pt-12">
      <section className="grid place-items-center md:grid-cols-2">
        ...
        <section className="flex w-[80%] flex-col gap-7">
          ...
          <p className="opacity-60">
            ...
            voluptatum cumque et veniam vero perferendis. Discover how we can
            help you achieve your goals with innovative solutions tailored to
            your needs.
          </p>
